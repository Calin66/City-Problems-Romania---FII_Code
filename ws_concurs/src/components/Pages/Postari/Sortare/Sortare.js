...
const Sortare = ({ crescData, crescNr, handleSortareData, handleSortareVoturi, handleFilterInt, handleFilterProp, handleFilterProb, handleFilterLike, handleFilterBook }) => {
  return (
    <div className="cp-sortare">
      ...
      <div className="cp-sortare-field">
        ...
        {crescData ? <AiOutlineArrowUp className="cp-sortare-arr" />: <AiOutlineArrowDown className="cp-sortare-arr" />}
        
      </div>
      <div className="cp-sortare-field">
        <h4 onClick={handleSortareVoturi}>Numarul de voturi</h4>
        {crescNr ? <AiOutlineArrowUp className="cp-sortare-arr" />: <AiOutlineArrowDown className="cp-sortare-arr" />}
